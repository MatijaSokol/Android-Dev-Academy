...
import hr.ferit.matijasokol.taskie.ui.fragments.AboutAppFragment
import hr.ferit.matijasokol.taskie.ui.fragments.AboutAuthorFragment
...
class ScreenSlidePagerAdapter(fm: FragmentManager) : FragmentStatePagerAdapter(fm) {
    ...
    private val titles = arrayOf(TAB_TEXT_APPLICATION, TAB_TEXT_AUTHOR)
